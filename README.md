...
- [[#Far Reaching Goals|Far Reaching Goals]]
- [[#Project Section|Project Section]]
- [[#Issues|Issues]]
- [[#Branching and Merging|Branching and Merging]]
- [[#Developer Contacts|Developer Contacts]]
- [[#Ideas or Suggestions|Ideas or Suggestions]]
- [[#Build Systems, Testing, and Continuous Integreation|Build Systems, Testing, and Continuous Integreation]]
- [[#Downloads|Downloads]]
- [[#1. System Requirements|1. System Requirements]]
	- [[#1. System Requirements#Windows|Windows]]
	- [[#1. System Requirements#macOS|macOS]]
- [[#2. Windows: Download and Install Android Studio|2. Windows: Download and Install Android Studio]]
	- [[#2. Windows: Download and Install Android Studio#Download Android Studio|Download Android Studio]]
	- [[#2. Windows: Download and Install Android Studio#Install Android Studio on Windows|Install Android Studio on Windows]]
- [[#2. macOS: Download and install Android Studio|2. macOS: Download and install Android Studio]]
	- [[#2. macOS: Download and install Android Studio#Download Android Studio|Download Android Studio]]
	- [[#2. macOS: Download and install Android Studio#Install Android Studio on macOS|Install Android Studio on macOS]]
- [[#Install Android Studio on macOS#Conclusion|Conclusion]]
		- [[#Conclusion#Summary|Summary]]
		- [[#Conclusion#Learn more|Learn more]]
- [[#3. Configure Android Studio and Run Frugl|3. Configure Android Studio and Run Frugl]]
	- [[#3. Configure Android Studio and Run Frugl#Downloading the Android Virtual Device (AVD) & Emulator Setup|Downloading the Android Virtual Device (AVD) & Emulator Setup]]
- [[#3. Configure Android Studio and Run Frugl#Quickstart: Android Emulator API and SDK Setup|Quickstart: Android Emulator API and SDK Setup]]
- [[#3. Configure Android Studio and Run Frugl#Gradle File:|Gradle File:]]
- [[#3. Configure Android Studio and Run Frugl#Setting Up|Setting Up]]
- [[#Using Frugl|Using Frugl]]
- [[#Testing|Testing]]
- [[#Testing#Unit Tests|Unit Tests]]
- [[#Testing#Integration & androidtests:|Integration & androidtests:]]
- [[#Testing#Running Tests:|Running Tests:]]
- [[#Common Issues|Common Issues]]
- [[#Common Issues#Gradle|Gradle]]
- [[#Common Issues#API Version|API Version]]
